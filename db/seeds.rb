...
def define_recipe(recipe, name, era, country, instructions, rating, prep_time, user, lon, lat, code)
  # recipe 1
  recipe.name = name
  recipe.era = era
  ...
  recipe.user = user
  recipe.longitude = lon
  recipe.latitude = lat
  recipe.country_code = code
  recipe.save!
end
...
def create_seed
  ...
  recipe_2.longitude = 41.902782
  recipe_2.latitude = 12.496366
  ...
  recipe_5.longitude = 41.902782
  recipe_5.latitude =  12.496366
  ...
  puts "recipe ingredients created!"
  ...
  puts "User favorites created!"

  puts ""
  puts "Uploading images..."
  progressbar = ProgressBar.create(:title => "Items", :starting_at => 0, :total => 40)
...
puts "time = #{Time.now - time_start} sec"
